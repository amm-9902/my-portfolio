...
const HeadSection = () => {
  return (
    <div className="w-[90%] py-24 max-w-[400] relative flex flex-col justify-between h-full">
      <div>
        <h1 className="text-5xl font-bold text-gray-200">John Does</h1>
        <p className="mt-4 text-xl font-semibold text-gray-200">Dveloper</p>
